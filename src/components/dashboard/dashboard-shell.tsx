...
const NAVS: Record<DashboardVariant, NavItem[]> = {
  ...
  admin: [
    ...
    { label: "Creator videos", href: "/admin/videos", icon: Clapperboard },
    ...
    { label: "Brand invoices", href: "/admin/invoices", icon: FileText },
    { label: "Money", href: "/admin/money", icon: Landmark },
